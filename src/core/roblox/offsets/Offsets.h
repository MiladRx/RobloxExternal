...
namespace Offsets {
    ...
    namespace Alloc {
         inline constexpr uintptr_t Malloc = 0x7c1a60;
    }
    ...
    namespace Attribute {
         ...
         inline constexpr uintptr_t TypeIdRva = 0x8924884;
         inline constexpr uintptr_t TypeIdRvaNew = 0x8924884;
    ...
    namespace ColorCorrectionEffect {
         ...
         inline constexpr uintptr_t Enabled = 0x30;
         inline constexpr uintptr_t TintColor = 0xb4;
    }
    ...
    namespace Humanoid {
         ...
         inline constexpr uintptr_t MoveDirection = 0x114;
    ...
    namespace Instance {
         ...
         inline constexpr uintptr_t ClassByName = 0x48b2bbe;
         ...
         inline constexpr uintptr_t FromExisting = 0x432a4f0;
         inline constexpr uintptr_t Name = 0x8;
         inline constexpr uintptr_t NameContainer = 0x70;
         inline constexpr uintptr_t New = 0x43297b0;
         inline constexpr uintptr_t Parent = 0x68;
         inline constexpr uintptr_t SetParent = 0x7c20d0;
    ...
    namespace ModuleScript {
         ...
         inline constexpr uintptr_t IsRobloxScript = 0x1518;
    }
