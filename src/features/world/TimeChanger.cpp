	...
	namespace Features {
		...
		bool TimeChanger::Apply(std::uint64_t lighting)
		{
			...
			if (w.time_changer)
			{
				...
				LightingInvalidate::force_write<Vector3>(lighting + Offsets::Lighting::SunPosition, sun_pos);
				LightingInvalidate::force_write<Vector3>(lighting + Offsets::Lighting::MoonPosition, moon_pos);
				LightingInvalidate::force_write<Vector3>(lighting + Offsets::Lighting::LightDirection, light_dir);
				...
				LightingInvalidate::force_write<Vector3>(lighting + Offsets::Lighting::GradientTop, grad_top);
				LightingInvalidate::force_write<Vector3>(lighting + Offsets::Lighting::GradientBottom, grad_bot);
				LightingInvalidate::force_write<Color3>(lighting + Offsets::Lighting::OutdoorAmbient, outdoor);
				LightingInvalidate::force_write<Color3>(lighting + Offsets::Lighting::Ambient, ambient);
				LightingInvalidate::force_write<Color3>(lighting + Offsets::Lighting::LightColor, light_col);
				LightingInvalidate::force_write<float>(lighting + Offsets::Lighting::Brightness, brightness);
